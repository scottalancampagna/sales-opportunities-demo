            ...
            <div className="card shadow-sm h-100">
              ...
              <div className="card-body">
                <div className="d-grid gap-3">
                  <button
                    onClick={() => window.location.hash = '#/add'}
                    className="btn btn-outline-primary d-flex align-items-center justify-content-between p-3 text-start"
                  >
                  ...
                  <button
                    ...
                    className="btn btn-outline-success d-flex align-items-center justify-content-between p-3 text-start"
                  >
                    <div className="d-flex align-items-center">
                  ...
                  <button
                    ...
                    className="btn btn-outline-info d-flex align-items-center justify-content-between p-3 text-start"
                  >
                    <div className="d-flex align-items-center">
                  ...
                  {user?.role === 'Admin' && (
                    <button
                      ...
                      className="btn btn-outline-warning d-flex align-items-center justify-content-between p-3 text-start"
                    >
                      <div className="d-flex align-items-center">
