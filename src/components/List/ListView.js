...
import { Search, Filter, Download, ChevronDown, ChevronUp, Check, X, Settings } from 'lucide-react';
...
const ListView = ({ stage = 'all' }) => {
  ...
  }, [opportunities, stage, searchTerm, filters, sortConfig]);
